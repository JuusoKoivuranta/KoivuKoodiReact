...
const Minesweeper = () => {
    ...
    const [assignedMines, setAssignedMines] = useState(new Set());
    ...
    const createBoard = (width, height, mineNum) => {
        const newBoard = [];
    ...
    const placeMines = (board, width, height, mineNum) => {
        let minesToPlace = mineNum;
        const newAssignedMines = new Set();
